...
class LongTermMemory:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        try:
            ...
            if not mem0_api_key:
                raise ValueError("MEM0_API_KEY not found. Set EDUX_MEM0_API_KEY env var or configure config.py")
            ...
            logger.info("To enable Mem0: set EDUX_MEM0_API_KEY env var or edit config.py")
            self.enabled = False
    ...
    def add_session_summary(
        ...
        try:
            ...
            answer = (answer or "").encode('utf-8', errors='replace').decode('utf-8')
            # 构建记忆文本（包含问题和答案摘要）
